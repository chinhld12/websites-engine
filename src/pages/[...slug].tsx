...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  const mdxSource = await serialize({
    ...
    options: {
      ...
      disableImports: true, // Disable imports for server-side rendering
      mdxOptions: {
        recmaPlugins: [recmaMdxEscapeMissingComponents],
        remarkPlugins: [remarkMdxImports, remarkTransformPaths],
      },
    },
  });
  ...
  return {
    ...
    // Enable ISR in development for hot-reload
